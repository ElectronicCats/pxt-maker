...
var JacDacDriverStatus = /** @class */ (function () {
    function JacDacDriverStatus(driverType, deviceClass, methods, controlData) {
    ...
    JacDacDriverStatus.prototype.isPairedInstanceAddress = function (address) {
        return 0;
    };
    return JacDacDriverStatus;
}());
var pxsim;
(function (pxsim) {
    var keyboard;
